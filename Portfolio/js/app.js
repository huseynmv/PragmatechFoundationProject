...
window.addEventListener('scroll', ()=>{
    ui.classList.toggle('animation', window.scrollY>200)
    marketing.classList.toggle('animation', window.scrollY>200)
    ecommerce.classList.toggle('animation', window.scrollY>200)
    copyright.classList.toggle('animation', window.scrollY>200)
})
